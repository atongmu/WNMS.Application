(function ($, learun) {
    ...
    var _jfgrid = {
        ...
        layout: function ($self, op) {
            ...
            // 没有数据的时候显示的图片
            $self.find('#jfgrid_body_' + op.id).append('<div class="jfgrid-nodata-img" id="jfgrid_nodata_img_' + op.id + '"  ><img src="../../../lib/img/jfgrid/nodata.jpg"></div>');
